...
void Miosha::Init() {
	...
	//ボスの設定
	Unit[(int)UnitType::MID_BOSS]->Init(dev, L"img\\Boss\\Mio.png");
	BossMid->SetPos(Vector2(0, -800));
	BossMid->SetScale(Vector2(0.1f));
	Unit[(int)UnitType::LAST_BOSS]->Init(dev, L"img\\Boss\\Mio.png");
...
void Miosha::CheckGameOverAfter()
{
...
void Miosha::CheckGameClearAfter()
{
