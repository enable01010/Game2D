...
class EasyMode_One :public BaseScene
{
	//ゲームプレイエリアの設定用
	...
	STG_Boss* BossMid = new STG_Boss_Okayu_Mid();
	STG_Boss* BossLast = new STG_Boss_Okayu_Last();
...
public:
	//オーバーロード
	EasyMode_One(ID3D12Device* Dev, ID3D12GraphicsCommandList* CmdList) :BaseScene(Dev, CmdList){}
	void Init();
	void Draw();
	bool Update();
	void onDestroy();
