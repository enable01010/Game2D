...
void STG_Boss_Miosha_Mid::BossAI(STG_Unit** unit)
{
	switch (State)
	{
...
void STG_Boss_Miosha_Mid::BossDestroy()
{

}

void STG_Boss_Miosha_Mid::Damage(int val)
{
...
void STG_Boss_Miosha_Mid::TimeOutAi(STG_Unit** unit)
{
	Pos += Vector2(0, -3);
	if (Pos.y <= -450) {
		isClear = true;
